...
class _Login2State extends State<Login2> {
  ...
  void dogrulamaYap() {
    if (pinValid == false) {
      ...
      if (box.read('girisDogrulamaKodu') != dogrulamaKodu.text) {
        uyari.warning(
            sistemCevirileri['Lütfen doğrulama kodunu doğru giriniz.'] ?? '');
        return;
      } else {
        if (box.read('userGEposta') != '') {
          Navigator.pushNamed(context, '/login-44');
        } else {
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            sistemCevirileri['Doğrulama kodunuz'] ?? '',
                            style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text(
                            sistemCevirileri[
                                    'Telefon numaranıza SMS ile gelen doğrulama kodunu giriniz.'] ??
                                '',
