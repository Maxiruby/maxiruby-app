...
class _Login4State extends State<Login4> {
  ...
  Future<void> kayitOl() async {
    ...
    var formData = FormData.fromMap({
      "telefon": box.read('userTelefon'),
      "adsoyad": box.read('userAdSoyad'),
      "referans": box.read('userReferans'),
      "eposta": box.read('userEposta'),
      "sifre": sifre.text,
      "dil": dil,
    });
    ...
    try {
      Response response = await Dio().post(
        Settings.apiUrl + "security/register",
        data: formData,
        options: Options(
  ...
  Future<void> girisYap() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        prefs.setString('u_username', box.read('userEposta'));
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            sistemCevirileri['Mükemmel! Şifreni belirle'] ?? '',
                            style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text(
                            sistemCevirileri[
                                    'Uygulama giriş yapmak için kullanacağın 6 haneli bir şifre belirle'] ??
                                '',
